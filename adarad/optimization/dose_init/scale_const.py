...
# Scaled beam seq_cvx with constant scaling factor (u >= 0), linear model (beta_t = 0) of PTV health status,
...
# Scaled beam seq_cvx with b_t = u*b^{static}, where u >= 0 is a scaling factor and b^{static} is a beam constant.
