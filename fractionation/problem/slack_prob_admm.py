...
from fractionation.problem.slack_prob import dyn_slack_problem, rx_to_slack_constrs

def build_dyn_slack_prob_dose(A_list, patient_rx, s_weights=defaultdict(lambda: 1.0), s_final=False):
    T_treat = len(A_list)
    K, n = A_list[0].shape
