...
def main():
	...
	# res_dynamic = dynamic_treatment_admm(A_list, F, G, r, h_init, patient_rx, health_map = health_map, rho = 10, max_iter = 1000, solver = "MOSEK", admm_verbose = True)
	...
	# res_mpc = mpc_treatment_admm(A_list, F, G, r, h_init, patient_rx, health_map = health_map, rho = 10, max_iter = 1000, solver = "MOSEK", mpc_verbose = True)
	print("\nMPC Treatment")
